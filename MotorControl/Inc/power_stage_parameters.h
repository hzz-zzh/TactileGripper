...
#define HW_DEAD_TIME_NS                      500 /*!< MCU-inserted dead-time; FD6288 adds internal dead-time
                                                      by HW if low side signals
                                                      are not used */
/*********** Bus voltage sensing section ****************/
#define VBUS_PARTITIONING_FACTOR             0.04761904761904762 /*!< 1k / (20k + 1k)
...
#define V0_V                                 0.314 /*!< in Volts */
#define T0_C                                 25 /*!< in Celsius degrees */
#define dV_dT                                0.02 /*!< V/Celsius degrees */

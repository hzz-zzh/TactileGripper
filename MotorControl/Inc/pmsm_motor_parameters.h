...
#define RS                      0.555 /* Phase resistance, ohm (half of line-line value) */
#define LS                      0.000142 /* Phase inductance, H (half of line-line value)
...
#define MOTOR_VOLTAGE_CONSTANT  6.16 /*!< Volts RMS ph-ph /kRPM at the motor shaft */
#define MOTOR_MAX_SPEED_RPM     7790 /*!< Maximum motor-shaft speed */
#define NOMINAL_CURRENT_A       1.0  /*!< Bring-up current limit */

#define ID_DEMAG_A              -1.0 /*!< Demagnetization current */

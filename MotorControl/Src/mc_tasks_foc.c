...
__weak void FOC_Init(void)
{
  ...
  /* USER CODE END MCboot 0 */
    ...
    /******************************************************/
    KTH7812_Init(&KTH7812_M1, &hspi1, KTH7812_NSS_GPIO_Port, KTH7812_NSS_Pin);

    /******************************************************/
    /*   Speed & torque component initialization          */
    /******************************************************/
    STC_Init(pSTC[M1],&PIDSpeedHandle_M1, &KTH7812_M1._Super);
...
__weak void TSK_MediumFrequencyTaskM1(void)
{
  ...
  int16_t wAux = 0;
  (void)KTH7812_CalcAvrgMecSpeedUnit(&KTH7812_M1, &wAux);
        ...
        case ALIGNMENT:
        {
          ...
          else
          {
            ...
            else
            {
              ...
              STC_SetSpeedSensor(pSTC[M1], &KTH7812_M1._Super);
              FOC_Clear(M1);
              R3_2_TurnOnLowSides(pwmcHandle[M1],M1_CHARGE_BOOT_CAP_DUTY_CYCLES);
              TSK_SetStopPermanencyTimeM1(STOPPERMANENCY_TICKS);
...
__weak uint8_t FOC_HighFrequencyTask(uint8_t bMotorNbr)
{
  ...
  if (KTH7812_Update(&KTH7812_M1) != KTH7812_OK)
  {
